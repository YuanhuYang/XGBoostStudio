...
| **参数配置** | 9 个 XGBoost 核心超参可视化配置 + 规则推荐引擎 |
...
**Q: 无需安装 Python 吗？**  
A: **Windows 安装包**用户无需安装。下载 exe 后双击安装，已内置全部依赖。  
...
**Updated**: 2026-04-06 | **v0.2.0-alpha**
