...
| 目录 | 用途 | 状态 | Cursor Skill @ 引用 |
|------|------|------|---------------------|
| **wiki/** | **产品设计思路、业务流程、技术架构（与版本同步维护，7篇知识库）** | **活跃（v0.3.0+）** | - |
| guides/ | 工程指南与流程规范 | 活跃 | - |
| iterations/ | 按迭代 ID 组织的过程文档 | 活跃（按需追加） | - |
| evidence/ | 跨迭代质量和验证证据 | 活跃 | - |
| archive/ | 已归档的历史文档（原 product/ + 需求规格文档） | **只读归档** | - |
| best-practices/ | 示例数据集建模最佳实践 | 活跃 | - |
