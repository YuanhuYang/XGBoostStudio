...
> **维护**：**质量门禁 / QA**（与 [`功能需求与验收状态.md`](功能需求与验收状态.md) §四 签核表「质量门禁」行一致）。**更新频率**：每增删自动化用例或完成一批手工 AC 后更新「最后证据日期」列。  
...
> **G1 信任链（AC 冻结 + 自动化/豁免 100%）**：见 [`章程.md`](../iterations/G1/章程.md)；下表每行 **必须** 有 pytest 或豁免编号。
...
## G2-Auth-1 运行档案（章程 · [`章程.md`](../iterations/G2-Auth-1/章程.md)）
...
| 最后更新 | 结论 |
|----------|------|
| 2026-04-05 | pytest 两行已绿；`acceptance_test.py` 含训练 SSE + provenance 断言；执行记录 [`执行记录.md`](../iterations/G2-Auth-1/执行记录.md) |

## G2-Auth-2 评估协议（章程 · [`章程.md`](../iterations/G2-Auth-2/章程.md)）
...
| 最后更新 | 结论 |
|----------|------|
| 2026-04-05 | `test_eval_protocol_g2_auth2.py` 全绿（含 `test_ac603_*`）；执行记录 [`执行记录.md`](../iterations/G2-Auth-2/执行记录.md)；GAP-G2-AUTH-002 已关 |

## G2-Auth-3 调优可信度（章程 · [`章程.md`](../iterations/G2-Auth-3/章程.md)）
...
| 最后更新 | 结论 |
|----------|------|
| 2026-04-06 | 见 [`执行记录.md`](../iterations/G2-Auth-3-4/执行记录.md) |

## G2-Auth-4 报告方法论表述（章程 · [`章程.md`](../iterations/G2-Auth-4/章程.md)）
...
| **G2-Auth-1** · 运行档案 | `test_provenance_g2_auth1.py`；`acceptance_test.py` [7/8]～[8/8] | [`执行记录.md`](../iterations/G2-Auth-1/执行记录.md) | 2026-04-05 | 自动化通过 |
| **G2-Auth-2** · 评估协议 | `test_eval_protocol_g2_auth2.py` | [`执行记录.md`](../iterations/G2-Auth-2/执行记录.md) | 2026-04-05 | 自动化通过 |
| **G2-Auth-3** · 调优可信度 | `test_tuning_g2_auth3.py` | [`执行记录.md`](../iterations/G2-Auth-3-4/执行记录.md) | 2026-04-06 | 自动化通过 |
| **G2-Auth-4** · 报告方法论 | `test_report_g2_auth4.py` | [`执行记录.md`](../iterations/G2-Auth-3-4/执行记录.md) | 2026-04-06 | 自动化通过 |
